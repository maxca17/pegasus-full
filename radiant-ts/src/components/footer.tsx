...
function SocialLinks() {
  return (
    <>
      ...
      <Link
        href="https://x.com/dreamventuresvc?prefetchTimestamp=1728349096230"
        target="_blank"
      ...
      <Link
        href="https://www.linkedin.com/company/dream-venturesvc"
        target="_blank"
...
function Copyright() {
  return (
    <div className="text-sm/6 text-gray-950">
      &copy; {new Date().getFullYear()} Dream Ventures
    </div>
  )
}
